...
/**
 * Breakpoint Test - Increase Stock
 *
 * 목적: 재고 증가의 최대 지속 가능 VU (Breaking Point) 탐색
...
export function handleSummary(data) {
  const html = generateHTMLReport(data, {
    title: 'Breakpoint Test - Increase Stock',
    theme: 'stress',
  });

  return {
    [resultPath('results/inventory/increase-stock/breakpoint.test.result.html')]: html,
