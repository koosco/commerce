...
/**
 * Baseline Test - Category Tree
 *
 * 목적: 정상 부하 환경에서 카테고리 트리 조회 성능 측정
 * - 일반적인 트래픽 패턴 시뮬레이션
 * - 성능 기준선(Baseline) 측정
 */
...
export function handleSummary(data) {
  const html = generateHTMLReport(data, {
    title: 'Baseline Test - Category Tree',
    theme: 'baseline',
  });

  return {
    [resultPath('results/catalog/category-tree/baseline.test.result.html')]: html,
