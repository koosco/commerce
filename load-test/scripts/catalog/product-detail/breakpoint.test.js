...
/**
 * Breakpoint Test - Product Detail
 *
 * 목적: 상품 상세 조회의 최대 지속 가능 VU (Breaking Point) 탐색
...
export function handleSummary(data) {
  const html = generateHTMLReport(data, {
    title: 'Breakpoint Test - Product Detail',
    theme: 'stress',
  });

  return {
    [resultPath('results/catalog/product-detail/breakpoint.test.result.html')]: html,
