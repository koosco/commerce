...
/**
 * Breakpoint Test - Product List
 *
 * 목적: 상품 목록 조회의 최대 지속 가능 VU (Breaking Point) 탐색
...
export function handleSummary(data) {
  const html = generateHTMLReport(data, {
    title: 'Breakpoint Test - Product List',
    theme: 'stress',
  });

  return {
    [resultPath('results/catalog/product-list/breakpoint.test.result.html')]: html,
