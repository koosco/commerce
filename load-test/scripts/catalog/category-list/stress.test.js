...
/**
 * Stress Test - Category List
 *
 * 목적: 고부하 환경에서 카테고리 목록 조회 시스템 한계 및 안정성 검증
...
export function handleSummary(data) {
  const html = generateHTMLReport(data, {
    title: 'Stress Test - Category List',
    theme: 'stress',
  });

  return {
    [resultPath('results/catalog/category-list/stress.test.result.html')]: html,
