...
/**
 * Breakpoint Test - Category List
 *
 * 목적: 카테고리 목록 조회의 최대 지속 가능 VU (Breaking Point) 탐색
...
export function handleSummary(data) {
  const html = generateHTMLReport(data, {
    title: 'Breakpoint Test - Category List',
    theme: 'stress',
  });

  return {
    [resultPath('results/catalog/category-list/breakpoint.test.result.html')]: html,
