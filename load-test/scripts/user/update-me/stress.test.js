...
/**
 * Stress Test - Update Me
 *
 * 목적: 고부하 환경에서 사용자 프로필 수정 시스템 한계 및 안정성 검증
 * - 대량의 동시 수정 요청 처리 능력 테스트
...
export function handleSummary(data) {
  const html = generateHTMLReport(data, {
    title: 'Stress Test - Update Me',
    theme: 'stress',
  });

  return {
    'results/user/update-me/stress.test.result.html': html,
