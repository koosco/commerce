 ...
 *
 * 목적: 고부하 환경에서 사용자 조회 시스템 한계 및 안정성 검증
    ...
    check(res, {
      'success response valid': (r) => {
        try {
          ...
          return body.success === true && body.data && body.data.id && body.data.email;
        } catch (e) {
...
export function handleSummary(data) {
  const html = generateHTMLReport(data, {
    title: 'Stress Test - Get User',
    theme: 'stress',
  });

  return {
    'results/user/get-user/stress.test.result.html': html,
