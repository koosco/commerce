...
public class ReduceStockUseCase {
    ...
    public ReduceStockUseCase(@org.jetbrains.annotations.NotNull()
    com.koosco.inventoryservice.inventory.application.port.InventoryStockStorePort inventoryStockStore) {
        super();
    }
    
    public void execute(@org.jetbrains.annotations.NotNull()
    com.koosco.inventoryservice.inventory.application.command.ReduceStockCommand command) {
    }
    
    public void execute(@org.jetbrains.annotations.NotNull()
    com.koosco.inventoryservice.inventory.application.command.BulkReduceStockCommand command) {
    }
}