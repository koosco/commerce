...
public class ConfirmStockUseCase {
    ...
    public ConfirmStockUseCase(@org.jetbrains.annotations.NotNull()
    ...
    com.koosco.inventoryservice.inventory.application.command.ConfirmStockCommand command, @org.jetbrains.annotations.NotNull()
    com.koosco.inventoryservice.common.MessageContext context) {
    }
    
    private void publishFailed(com.koosco.inventoryservice.inventory.application.command.ConfirmStockCommand command, com.koosco.inventoryservice.common.MessageContext context, com.koosco.inventoryservice.inventory.domain.enums.StockConfirmFailReason reason) {
    }
}