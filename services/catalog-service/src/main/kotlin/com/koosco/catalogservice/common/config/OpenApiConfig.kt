        ...
        .info(
            Info()
                ...
                .description(
                    ...
                    Product and category management service for e-commerce platform.

                    ## Key Features
                    - **Product Management**: Create, read, update, delete products with options and SKUs
                    ...
                    - Anonymous access allowed for product browsing
                    """.trimIndent(),
                ),
        )
        .servers(
