    ...
    fun execute(command: CreateProductCommand, idempotencyKey: String? = null): ProductInfo {
        if (idempotencyKey != null) {
            ...
            if (existing != null) {
                ...
                return ProductInfo.Companion.from(product)
            }
        }
        ...
        val product = Product.Companion.create(
            name = command.name,
        ...
        if (idempotencyKey != null) {
            catalogIdempotencyRepository.save(
                CatalogIdempotency.Companion.create(idempotencyKey, "PRODUCT", savedProduct.id!!),
            )
        }
