package com.koosco.catalogservice.application.usecase.promotion
...
class CreatePromotionUseCase(
    ...
    fun execute(command: CreatePromotionCommand): PromotionInfo {
        ...
        val promotion = Promotion.Companion.create(
        ...
        return PromotionInfo.Companion.from(savedPromotion)
    }
}
